...
public class FactorNode {
	...
	static {
		...
		try {
			BufferedReader readTxt=new BufferedReader(new FileReader("/home/mhzeng/ppfl/infer.txt"));
	...
	private void change_parameters(){
		...
		//if (special){//read from file
		//	LOW = numbersArray.get(0);
		//	MEDIUM_LOW = numbersArray.get(1);
		//	MEDIUM_HIGH = numbersArray.get(2);
		//	HIGH = numbersArray.get(3);
		//}
		//else{
		//	LOW = numbersArray.get(4);
		//	MEDIUM_LOW = numbersArray.get(5);
		//	MEDIUM_HIGH = numbersArray.get(6);
		//	HIGH = numbersArray.get(7);
		//}
	...
	public double getProb() {
		...
		// if (special){//read from file
		// 	HIGH = Double.parseDouble(numbersArray[1]);
		// 	MEDIUM = Double.parseDouble(numbersArray[2]);
		// 	LOW = Double.parseDouble(numbersArray[3]);
		// }
		// else{
		// 	HIGH = Double.parseDouble(numbersArray[4]);
		// 	MEDIUM = Double.parseDouble(numbersArray[5]);
		// 	LOW = Double.parseDouble(numbersArray[6]);
		// }
